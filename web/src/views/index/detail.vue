      ...
      <div class="detail-content">
        <div class="detail-content-top">
          ...
          <div class="top-right">
            ...
            <div class="meta">等级：{{ detailData.level }}</div>
            <div class="meta">地址：{{ detailData.address }}</div>
            <div class="meta">营业时间：{{ detailData.yy_time }}</div>
            <div class="actions">
                ...
                <div class="things">
                  <div class="thing-item" v-for="item in recommendData" @click="handleDetail(item)">
                    ...
                    <div class="info-view">
                      ...
                      <span>
                        <span class="a-price">{{ item.price }}元</span>&nbsp; <span class="a-price">{{ item.level }}</span
                        >&nbsp;
